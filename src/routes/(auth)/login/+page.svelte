<script lang="ts">
	...
	const demoAccounts = [
		{ role: Role.SUPER_ADMIN, email: 'admin@dyinnovate.com', label: 'MANUFACTURER' },
		{ role: Role.TENANT_OWNER, email: 'owner@golfcourse.com', label: 'GOLF COURSE OWNER' },
		{ role: Role.TENANT_MANAGER, email: 'manager@golfcourse.com', label: 'GOLF COURSE MANAGER' },
		{ role: Role.SYSTEM_ADMIN, email: 'dev@via.com', label: 'SYSTEM ADMIN' },
		{ role: Role.OPERATION_STAFF, email: 'staff@golfcourse.com', label: 'OPERATION STAFF' }
	];
