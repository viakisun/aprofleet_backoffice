  ...
  async function sendCommand(command: string) {
    ...
    if (result.success) {
      notification.success(
        `COMMAND SENT`,
        `${command.toUpperCase()} sent to ${vehicleData.vin}`,
      );
    } else {
...
<div
  class="vehicle-card"
  class:compact
  class:error={vehicleData.status === "error"}
  class:warning={vehicleData.status === "warning"}
>
  <!-- Header -->
  <div class="card-header">
    <div class="header-left">
      <span class="status-indicator"
        >{getStatusIndicator(vehicleData.status)}</span
      >
    ...
    <div class="card-section">
      ...
      <div class="battery-display" class:low={isLowBattery}>
        <div class="battery-bar">
          {getBatteryBar(vehicleData.battery.level)}
        </div>
      ...
      <div class="battery-details">
        ...
        <div class="detail-item">
          ...
          <span class="detail-value"
            >{vehicleData.battery.voltage.toFixed(1)} V</span
          >
        </div>
        <div class="detail-item">
          <span class="detail-label">TEMP:</span>
          <span class="detail-value"
            >{vehicleData.battery.temperature.toFixed(1)} °C</span
          >
        </div>
      </div>
    </div>
      ...
      <div class="location-grid">
        <div class="location-item">
          ...
          <span class="location-value"
            >{vehicleData.location.latitude.toFixed(6)}</span
          >
        </div>
        <div class="location-item">
          <span class="location-label">LNG:</span>
          <span class="location-value"
            >{vehicleData.location.longitude.toFixed(6)}</span
          >
        </div>
        <div class="location-item">
      ...
      <div class="health-grid">
        <div class="health-item">
          ...
          <span class="health-bar"
            >{getHealthBar(vehicleData.health.motor)}</span
          >
        ...
        <div class="health-item">
          ...
          <span class="health-bar"
            >{getHealthBar(vehicleData.health.battery)}</span
          >
        ...
        <div class="health-item">
          ...
          <span class="health-bar"
            >{getHealthBar(vehicleData.health.brakes)}</span
          >
        ...
        <div class="health-item">
          ...
          <span class="health-bar"
            >{getHealthBar(vehicleData.health.tires)}</span
          >
      ...
      <div class="usage-grid">
        <div class="usage-item">
          <span class="usage-value"
            >{vehicleData.usage.totalDistance.toLocaleString()}</span
          >
          <span class="usage-label">TOTAL KM</span>
        </div>
        <div class="usage-item">
          <span class="usage-value"
            >{vehicleData.usage.totalHours.toLocaleString()}</span
          >
