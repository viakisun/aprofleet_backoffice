<script lang="ts">
	...
	import { auth, Role, isManufacturer, isTenantAdmin, isSystemAdmin } from '$lib/stores/auth';
	...
	$: connectionIcon = connectionStatus === 'connected' ? '●' :
...
<div class="app-shell" class:sidebar-open={isSidebarOpen}>
	...
	<header class="header">
		...
		<div class="header-center">
			{#if $vehicleStatistics}
				<div class="quick-stats">
					...
					<div class="stat">
						<span class="stat-value">{$vehicleStatistics.warning + $vehicleStatistics.error}</span>
		...
		<div class="header-right">
			...
			<div class="connection-indicator" title="Connection status: {connectionStatus}">
